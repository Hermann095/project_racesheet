...
def runTestQualifying():
    ...
    entry_a = RaceEntry("13", "Team A", "#000000", Chassis("Chassis A", "Team A", 500, 500, 500, 500, 350, 500), Engine("Engine A", 500, 500, 500, 500, 500, 155, 500), Tyres("Tyre A", 500, 500, 500, 500), [Driver("Heinz-Harald Frentzen", "DEU", "Team A", 500, 500, 500, 500, 500)])
    entry_a2 = RaceEntry("14", "Team A", "#5313EB", Chassis("Chassis A", "Team A", 500, 500, 500, 500, 350, 500), Engine("Engine A", 500, 500, 500, 500, 500, 155, 500), Tyres("Tyre A", 500, 500, 500, 500), [Driver("a2", "FIN", "Team A", 500, 500, 500, 500, 500)])
    ...
    entry_c = RaceEntry("1", "Team C", "#EBDD13", Chassis("Chassis C", "Team C", 100, 100, 1000, 100, 350, 100), Engine("Engine A", 100, 100, 100, 100, 100, 155, 100), Tyres("Tyre A", 100, 100, 100, 100), [Driver("c", "FRA", "Team A", 100, 100, 100, 100, 100)])
